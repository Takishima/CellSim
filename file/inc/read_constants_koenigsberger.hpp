...
#ifndef READ_CONSTANTS_KOENIGSBERGER_HPP_INCLUDED
#define READ_CONSTANTS_KOENIGSBERGER_HPP_INCLUDED
...
namespace input {
      ...
      */
     void print_constants_values(const koenigs::Constants_Values& C);
...
#endif //READ_CONSTANTS_KOENIGSBERGER_HPP_INCLUDED
